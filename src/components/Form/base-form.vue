<template>
  <div class="content">
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12" v-for="(item,key) in formConfigs"
                :key="key">
          <el-form-item
            ...
            <el-upload
              ...
              :data="qiniuData">
              <img v-if="img_url" :disabled="formStatus==='show'"
                   :src="img_url" class="avatar">
              <img v-else-if="form[item.formItemProp.prop]" :disabled="formStatus==='show'"
                   :src="form[item.formItemProp.prop]" class="avatar">

  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="equipmentModelFormConfigs"
...
<script>
  ...
  import { equipmentModelFormConfigs } from '../../components/Form/form-configs.js'

  export default {
    data() {
      return {
        pageInfo: {
          interfaceName: 'equipment-model',   //接口名称
          listTitle: '设备型号列表',
          detailTitle: '设备型号详细信息'
        },   //页面信息
        search_data: {},          //搜索条件
        clickLineId: '',       //当前点击行id

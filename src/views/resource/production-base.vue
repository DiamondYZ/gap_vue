        ...
        watch: {
            listeningClickDialog(val) {
                if (val) {
                    ...
                    let param;
                    if (val === 'manager') {
                        param = {url: 'staff' + '/getPullDownList'}
                    }
                    if (val === 'province') {
                        param = {url: 'province' + '/getPullDownList'}
                    }
                    if (val === 'city') {
                        param = {
                            url: 'city' + '/getPullDownList',
                            data: {'provinceCode': provinceCode}
                        }
                    }
                    if (val === 'area') {
                        param = {
                            url: 'area' + '/getPullDownList',
                            data: {'cityCode': cityCode}
                        }
                    }
                    if (val === 'street') {
                        param = {
                            url: 'street' + '/getPullDownList',

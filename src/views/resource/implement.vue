  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
              ...
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                <el-form-item label="输入搜索：">
                  <el-input style="width: 203px" v-model="search_data.customCondition"
                            placeholder="编号、名称"></el-input>
                </el-form-item>
                <el-form-item label="机具类型：">
                  <el-input style="width: 203px" v-model="search_data.implementTypeId" placeholder=""></el-input>
                </el-form-item>
                <el-form-item label="机具型号：">
                  <el-input style="width: 203px" v-model="search_data.implementModelId" placeholder=""></el-input>
                </el-form-item>
              </el-form>
            </div>
          </el-card>
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="implementFormConfigs"
...
<script>
  ...
  import { implementFormConfigs, formData } from '../../components/Form/form-configs.js'
  ...
  export default {
    data() {
      return {
        ...
        tableTitleList: [
          { prop: 'implementTypeNumber', name: '机具类型编号' },
          { prop: 'implementTypeName', name: '机具类型名称' },
          { prop: 'description', name: '机具描述' },

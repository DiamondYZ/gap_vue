  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="equipmentTypeFormConfigs"
...
<script>
    ...
    import {equipmentTypeFormConfigs} from '../../components/Form/form-configs.js'
    ...
    export default {
        ...
        created() {
            ...
            this.$store.dispatch('common/getPullDownList', {classCode: 'IS_VALID'}) // 是否有效
        },
        mounted() {
            this.getList()
        },

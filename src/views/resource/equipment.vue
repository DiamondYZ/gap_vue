  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                ...
                <el-form-item label="设备类型：">
                  <el-input style="width: 203px" v-model="search_data.equipmentTypeId" placeholder=""></el-input>
                </el-form-item>
                <el-form-item label="设备型号：">
                  <el-input style="width: 203px" v-model="search_data.equipmentModelId" placeholder=""></el-input>
                </el-form-item>
                <el-form-item label="设备状态：">
                  <el-select class="item-choose" v-model="search_data.availableStatus" size="small">
                    <el-option label="" value=""></el-option>
                    <el-option label="设备状态1" value="0"></el-option>
                    <el-option label="设备状态2" value="1"></el-option>
                  </el-select>
                </el-form-item>
              </el-form>
            </div>
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="equipmentFormConfigs"
...
<script>
  ...
  import { equipmentFormConfigs, formData } from '../../components/Form/form-configs.js'
    ...
    data() {
      return {
        ...
        tableTitleList: [
          ...
          { prop: 'manufacturerName', name: '制造商' },

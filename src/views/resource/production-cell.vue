          ...
          <el-card class="filter-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="mini" label-width="140px">
                <el-form-item label="">
                  <el-input v-model="search_data.customCondition" style="width: 200px" placeholder="编号、描述"/>
                </el-form-item>
...
<!--                  <el-input-->
<!--                    v-model="search_data.managerCondition"-->
<!--                    style="width: 200px"-->
<!--                    placeholder="责任人编号、名称、描述"-->
<!--                  />-->
<!--                </el-form-item>-->
              </el-form>
            </div>
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="productionCellFormConfigs"
...
<script>
    ...
    import {productionCellFormConfigs} from '../../components/Form/form-configs.js'

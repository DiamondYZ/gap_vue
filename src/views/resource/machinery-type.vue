  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
        ...
        <div style="margin-top: 15px">
          <el-form :inline="true" :model="search_data" size="small" label-width="140px">
            <el-form-item label="输入搜索：">
              <el-input style="width: 203px" v-model="search_data.customCondition" placeholder="编号、名称、描述"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </el-card>
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="materialTypeFormConfigs"
...
<script>
  ...
  import { materialTypeFormConfigs, formData } from '../../components/Form/form-configs.js'

  export default {
    data() {
      return {
        pageInfo: {
          interfaceName: 'material-type',   //接口名称
          listTitle: '物料类型列表',
          detailTitle: '物料类型详细信息'
        },   //页面信息
        search_data: {},          //搜索条件
        clickLineId: '',       //当前点击行id

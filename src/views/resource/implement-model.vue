  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="implementModelFormConfigs"
...
<script>
  ...
  import { implementModelFormConfigs, formData } from '../../components/Form/form-configs.js'

  export default {
    data() {
      return {
        pageInfo: {
          interfaceName: 'implement-model',   //接口名称
          listTitle: '机具型号列表',
          detailTitle: '机具型号信息'
        },   //页面信息
        search_data: {},          //搜索条件

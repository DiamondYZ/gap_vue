  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
              ...
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                <el-form-item label="输入搜索：">
                  <el-input style="width: 203px" v-model="search_data.customCondition"
                            placeholder="编号、名称、描述"></el-input>
                </el-form-item>
                <el-form-item label="物料类型：">
                  <el-input style="width: 203px" v-model="search_data.materialTypeId" placeholder=""></el-input>
                </el-form-item>
              </el-form>
            </div>
          </el-card>
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="materialFormConfigs"
...
<script>
  ...
  import { materialFormConfigs, formData } from '../../components/Form/form-configs.js'

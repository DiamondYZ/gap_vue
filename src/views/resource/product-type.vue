  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="productTypeFormConfigs"
...
<script>
  ...
  import { productTypeFormConfigs, formData } from '../../components/Form/form-configs.js'

  export default {
    data() {
      return {
        pageInfo: {
          interfaceName: 'product-type',   //接口名称
          listTitle: '产品类型列表',
          detailTitle: '产品类型详细信息'
        },   //页面信息
        search_data: {},          //搜索条件
        clickLineId: '',       //当前点击行id

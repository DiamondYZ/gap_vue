  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="departmentFormConfigs"
                        @getList="getList(nowPage)">
      </show-detail-form>
      <dialog-table
        ref="dialogSelectTable"
        :dialog-info="dialogInfo"
        :form-configs="departmentFormConfigs"
...
<script>
    ...
    import {departmentFormConfigs, formData} from '../../components/Form/form-configs.js'

    export default {
        data() {
            return {
                pageInfo: {
                    interfaceName: 'department',   //接口名称
                    listTitle: '部门列表',
                    detailTitle: '部门详细信息'
                },   //页面信息
                dialogInfo: {
                    selectDialogTitle: '选择负责人',
        ...
        methods: {
            ...
            getList() {
                let data = {
                    'entity': {
                        'customCondition': this.search_data.customCondition
                    },
                    'orders': [{
                        'asc': false,
                        'column': 'crt_time'

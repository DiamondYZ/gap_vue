  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                ...
                <el-form-item label="生产基地：">
                  <el-input
                    v-model="search_data.productionBaseCondition"
                    style="width: 203px"
                    placeholder="生产基地编号、名称、描述"
                  />
                </el-form-item>
              </el-form>
            </div>
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="productionPlanFormConfigs"
...
import { productionPlanFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      pageInfo: {
        interfaceName: 'production-plan', // 接口名称
        listTitle: '生产计划列表',
        detailTitle: '生产计划详细信息',
        listDetailTitle: '生产计划明细列表'
      }, // 页面信息
      search_data: {}, // 搜索条件
      clickLineId: '', // 当前点击行id
      ...
      activeNames: [],
      productionPlanFormConfigs,
      tableDetailData: [], // 表格单条数据
      secondLevelTableTitleList: [
        { prop: 'productionPlanNumber', name: '生产计划编号' },
        { prop: 'productionPlanDescription', name: '生产计划描述' },
        { prop: 'productNumber', name: '产品编号' },
        { prop: 'productName', name: '产品名称' },
        { prop: 'productDescription', name: '产品描述' },
        { prop: 'quantity', name: '数量' },
        { prop: 'quantityUnitDict', name: '单位' }
      ],

  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="taskTypeFormConfigs"
...
import { taskTypeFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      pageInfo: {
        interfaceName: 'task-type', // 接口名称
        listTitle: '任务类型列表',
        detailTitle: '任务类型详细信息'
      }, // 页面信息
      search_data: {}, // 搜索条件
      clickLineId: '', // 当前点击行id

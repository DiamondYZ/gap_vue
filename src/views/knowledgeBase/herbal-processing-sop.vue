  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
          ...
          <el-card class="filter-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="mini" label-width="140px">
                <el-form-item label="">
                  <el-input v-model="search_data.customCondition" style="width: 203px" placeholder="编号或描述" />
                </el-form-item>
                <el-form-item label="产品">
                  <el-input v-model="search_data.productCondition" style="width: 203px" placeholder="产品编号或名称" />
                </el-form-item>
              </el-form>
            </div>
          </el-card>
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="herbalProcessingSopFormConfigs"
        @getList="getList()"
      />
      <dialog-table
...
import { herbalProcessingSopFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      pageInfo: {
        interfaceName: 'herbal-processing-sop', // 接口名称
        listTitle: '加工sop列表',
        detailTitle: '加工sop详细信息'
      }, // 页面信息
      dialogInfo: {
      ...
      pageTotal: 0, // 总条数
      activeNames: [],
      herbalProcessingSopFormConfigs,
      tableTitle: []
    }
  },
  computed: {
  ...
  created() {
    ...
    //     value: '2'
    //   }]}
    // localStorage.setItem('select', JSON.stringify(a))
  },
  mounted() {
    this.getList()
  },

  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="plantSopFormConfigs"
        @getList="getList()"
      />
      <dialog-table
...
import { plantSopFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      pageInfo: {
        interfaceName: 'plant-sop', // 接口名称
        listTitle: '种植SOP列表',
        detailTitle: '种植SOP详细信息'
      }, // 页面信息
      dialogInfo: {

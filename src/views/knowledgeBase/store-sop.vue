  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="storeSopFormConfigs"
...
import { storeSopFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      pageInfo: {
        interfaceName: 'store-sop', // 接口名称
        listTitle: '存储SOP列表',
        detailTitle: '存储SOP详细信息'
      }, // 页面信息
      dialogInfo: {
  ...
  created() {
    this.$store.dispatch('common/getPullDownList', { classCode: 'HUMIDITY_UNIT_DICT' }) // 湿度单位

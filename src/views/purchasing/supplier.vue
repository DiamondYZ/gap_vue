...
<!--                  <el-select v-model="search_data.companyTypeDict" class="item-choose" size="mini">-->
<!--                    <el-option label="" value="" />-->
<!--                    <el-option label="公司类型1" value="0" />-->
<!--                    <el-option label="公司类型2" value="1" />-->
<!--                  </el-select>-->
<!--                </el-form-item>-->
              </el-form>
            </div>
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="supplierFormConfigs"
...
import { supplierFormConfigs, formData } from '../../components/Form/form-configs.js'
  ...
  data() {
    return {
      ...
      tableTitleList: [
        ...
        { prop: 'contactName', name: '联系人' },
        { prop: 'contactPhone', name: '电话' },

  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                ...
                <el-form-item label="是否必须满足存储条件：">
                  <el-select v-model="search_data.isMustStoreCondition" class="item-choose" size="small">
                    <el-option label="" value="" />
                    <el-option label="必须" value="0" />
                    <el-option label="不必须" value="1" />
                  </el-select>
                </el-form-item>
                <el-form-item label="是否库位控制：">
                  <el-select v-model="search_data.isLocationControlled" class="item-choose" size="small">
                    <el-option label="" value="" />
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="warehouseAreaFormConfigs"

  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
              ...
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                <el-form-item label="输入搜索：">
                  <el-input style="width: 203px" v-model="search_data.customCondition"
                            placeholder="编号、描述"></el-input>
                </el-form-item>
                <el-form-item label="库房：">
                  <el-select class="item-choose" v-model="search_data.warehouseId" size="small">
                    <el-option label="" value=""></el-option>
                    <el-option label="库房1" value="0"></el-option>
                    <el-option label="库房2" value="1"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="是否必须满足存储条件：">
                  <el-select class="item-choose" v-model="search_data.isMustStoreCondition" size="small">
                    <el-option label="" value=""></el-option>
                    <el-option label="必须" value="0"></el-option>
                    <el-option label="不必须" value="1"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="是否库位控制：">
                  <el-select class="item-choose" v-model="search_data.isLocationControlled" size="small">
                    <el-option label="" value=""></el-option>
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="warehouseAreaFormConfigs"
...
<script>
  ...
  import { warehouseAreaFormConfigs, formData } from '../../components/Form/form-configs.js'

  export default {
    data() {
      return {
        pageInfo: {
          interfaceName: 'warehouse-area',   //接口名称
          listTitle: '库区列表',
          detailTitle: '库区详细信息'
        },   //页面信息
        search_data: {},          //搜索条件
        ...
        tableTitleList: [
          { prop: 'number', name: '库区编号' },
          { prop: 'description', name: '库区描述' },
          { prop: 'position', name: '库区位置' },
          { prop: 'warehouseId', name: '所属仓库' }
        ],  //表格头信息
        tableData: [],    //表格数据
        formData: {},   //表单数据
        loading: false,

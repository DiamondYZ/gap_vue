  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                ...
                <el-form-item label="库区：">
                  <el-select v-model="search_data.areaId" class="item-choose" size="small">
                    <el-option label="" value="" />
                    <el-option label="库区1" value="0" />
                    <el-option label="库区2" value="1" />
                  </el-select>
                </el-form-item>
              </el-form>
            </div>
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="warehouseLocationFormConfigs"
...
import { warehouseLocationFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      pageInfo: {
        interfaceName: 'warehouse-location', // 接口名称
        listTitle: '库位列表',
        detailTitle: '库位详细信息'
      }, // 页面信息
      search_data: {}, // 搜索条件
      ...
      tableTitleList: [
        { prop: 'number', name: '库位编号' },
        { prop: 'description', name: '库位描述' },
        { prop: 'rowNumber', name: '架号' },
        { prop: 'levelNumber', name: '层号' },
        { prop: 'binNumber', name: '位号' },
        { prop: 'warehouseId', name: '所属仓库' },
        { prop: 'areaId', name: '所属库区' },
        { prop: 'materialId', name: '物料' }
      ], // 表格头信息
      tableData: [], // 表格数据
      formData: {}, // 表单数据
      loading: false,

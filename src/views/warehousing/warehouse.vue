  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
            ...
            <div style="margin-top: 15px">
              <el-form :inline="true" :model="search_data" size="small" label-width="140px">
                ...
                <el-form-item label="仓库类型：">
                  <el-select class="item-choose" v-model="search_data.typeDict" size="small">
                    <el-option label="" value=""></el-option>
                    <el-option label="仓库类型1" value="0"></el-option>
                    <el-option label="仓库类型2" value="1"></el-option>
                  </el-select>
                </el-form-item>
              </el-form>
            </div>
      ...
      <show-detail-form ref="detailForm" :pageInfo=pageInfo
                        :formConfigs="warehouseFormConfigs"
                        @getList="getList()">
      </show-detail-form>
    </el-card>
  </div>

  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="processingFormConfigs"
        @getList="getList()"
      />
    </el-card>
  </div>
...
import { processingFormConfigs, formData } from '../../components/Form/form-configs.js'

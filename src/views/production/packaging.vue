  ...
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <show-detail-form
        ref="detailForm"
        :page-info="pageInfo"
        :form-configs="packagingFormConfigs"
        @getList="getList()"
      />
    </el-card>
  </div>
...
import { packagingFormConfigs, formData } from '../../components/Form/form-configs.js'
...
export default {
  ...
  data() {
    return {
      ...
      tableTitleList: [
        { prop: 'brandName', name: '品名' },
        { prop: 'specification', name: '规格' },
        { prop: 'origin', name: '产地' },
        { prop: 'lotNumber', name: '批号' },
        { prop: 'productionUnit', name: '生产单位' },
        { prop: 'packingTime', name: '包装日期' },
